...
import com.example.wastewizard.ml.ModelUnquant;
...
public class ZeroWasteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ZeroWasteActivity.this, "request send", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void classifyImage(Bitmap image) {
        try {
            ...
            String[] classes = {"Solid Waste", "E-Waste"};
